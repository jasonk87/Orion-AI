...
class WorkspaceIndexService {
  ...
  recordFileRead(relativePath) {
    return require('./file-knowledge').recordFileRead(this.workspacePath, relativePath);
  }

  saveFileDigest(relativePath, digest) {
    return require('./file-knowledge').saveFileDigest(this.workspacePath, relativePath, digest);
  }

  buildKnowledgeBrief({ maxDigests = 25 } = {}) {
    return require('./file-knowledge').buildKnowledgeBrief(this.workspacePath, { maxDigests });
  }
