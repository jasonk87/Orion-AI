  ...
  <div id="screen-main" class="screen">
    ...
    <div class="tab-panels">
      ...
      <div class="tab-panel" id="panel-status">
        ...
        <div style="display:flex; align-items:center; justify-content:space-between; padding:8px 2px; margin-bottom:2px;">
          <span id="update-check-status" style="font-size:0.75rem; color:var(--muted);">Checking for updates…</span>
