...
<script>
  ...
  function applyState(state) {
      ...
      statusPillEl.textContent = phonePresentation.agentState;
      statusPillEl.classList.toggle('running', phonePresentation.isRunning);
      statusEl.textContent = phonePresentation.detail;
