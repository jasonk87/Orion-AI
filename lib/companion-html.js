...
const COMPANION_CLIENT_BUILD = 'ui-polish-v15';
    ...
    <aside class="app-drawer">
      ...
      <nav class="drawer-nav" aria-label="Main">
        <button class="drawer-nav-btn" data-drawer-destination="orion" type="button">
          <span>Dispatch</span><span class="drawer-nav-sub">Conversations</span>
        </button>
...
<script>
  ...
  function updateDrawerState() {
    ...
    document.querySelectorAll('[data-drawer-destination]').forEach(btn => {
      ...
      const active = destination === 'settings'
        ? currentScreen === 'screen-settings'
        : currentScreen !== 'screen-settings' && activeMode === destination;
